...
- `outputs/design/mysynthesizer-synthesizer-design.md`：合成器机制、正向模型、AI 操作规则的统一设计文档。
- `outputs/data/current/`：当前最新可用合成数据。

## 重要文件

- `outputs/design/mysynthesizer-synthesizer-design.md`  
...
1. 先读本 README。
2. 如果要理解合成器机制或规划后续合成路线，读 `outputs/design/mysynthesizer-synthesizer-design.md`。
...
- 合成器设计文档移动到 `outputs/design/`。
- 三份旧设计文档已合并为 `outputs/design/mysynthesizer-synthesizer-design.md`，旧稿已删除。
